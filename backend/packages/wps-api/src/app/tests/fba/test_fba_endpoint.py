...
async def mock_get_fire_centre_info(*_, source_identifiers=None, **__):
    return {int(source_id): mock_fire_centre_info for source_id in source_identifiers or []}
...
async def mock_get_fire_centre_info_with_grass(*_, source_identifiers=None, **__):
    return {
        int(source_id): mock_fire_centre_info_with_grass for source_id in source_identifiers or []
    }
